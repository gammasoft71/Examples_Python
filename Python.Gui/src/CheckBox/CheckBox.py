...
class Form1(tkinter.Tk):
  def __init__(self):
    ...
    self.checkBox1 = tkinter.ttk.Checkbutton(self.frame, text="Checked", variable=self.checkBoxVar1)
    self.checkBox1.place(x = 30, y = 30) 
    
    self.checkBoxVar2 = tkinter.BooleanVar()
    self.checkBoxVar2.set(False)
    
    self.checkBox2 = tkinter.ttk.Checkbutton(self.frame, text="Unchecked", variable=self.checkBoxVar2)
    self.checkBox2.place(x = 30, y = 60) 
    
    self.checkBox3 = tkinter.ttk.Checkbutton(self.frame, text="Indeterminate", variable=None)
