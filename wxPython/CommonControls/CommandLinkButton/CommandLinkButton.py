...
class Frame1(wx.Frame):
  def __init__(self):
    ...
    self.commandLinkButton1 = wx.adv.CommandLinkButton(self.panel, wx.ID_ANY, 'Link', 'Information text', wx.Point(30, 30), wx.Size(150, 40))
    self.commandLinkButton1.Bind(wx.EVT_BUTTON, self.OnCommandLinkButton1Click)
    self.staticText1 = wx.StaticText(self.panel, wx.ID_ANY, 'commandLinkButton1 clicked 0 times', wx.Point(30, 100), wx.Size(200, 20))
